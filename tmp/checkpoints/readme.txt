...
PostgreSQL:
	...
	- To create the tables, use the file called tables.sql. import this file in your postgreSQL and run it.
...
2. Files and their purpose:
	...
	8. tables file (tables.sql): import then run it from postgreSQL query tool
